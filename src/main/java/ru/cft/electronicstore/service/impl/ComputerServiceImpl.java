...
import ru.cft.electronicstore.repository.TechniqueRepository;
...
@Service
public class ComputerServiceImpl implements TechniqueService<Computer> {
    ...
    @Override
    public void update(Long id, Computer newComputer) {
